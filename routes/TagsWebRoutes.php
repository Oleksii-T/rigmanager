...
Route::get('nasosy-dlya-burovoj',     'SearchController@searchTag')->name('tag-4');
    ...
    Route::get('nasosy-dlya-burovoj/komponenty',     'SearchController@searchTag')->name('tag-4.8');
...
Route::get('burovoj-rastvor-tsirkulyatsiya',     'SearchController@searchTag')->name('tag-5');
    Route::get('burovoj-rastvor-tsirkulyatsiya/filtry',     'SearchController@searchTag')->name('tag-5.1');
    Route::get('burovoj-rastvor-tsirkulyatsiya/shlangi',     'SearchController@searchTag')->name('tag-5.2');
    ...
    Route::get('burovoj-rastvor-tsirkulyatsiya/bufernaya-emkost',     'SearchController@searchTag')->name('tag-5.6');
    Route::get('burovoj-rastvor-tsirkulyatsiya/ochistka',     'SearchController@searchTag')->name('tag-5.7');
        Route::get('burovoj-rastvor-tsirkulyatsiya/ochistka/vibrosita',     'SearchController@searchTag')->name('tag-5.7.1');
        Route::get('burovoj-rastvor-tsirkulyatsiya/ochistka/degazatory',     'SearchController@searchTag')->name('tag-5.7.2');
        Route::get('burovoj-rastvor-tsirkulyatsiya/ochistka/ilo-otdeliteli',     'SearchController@searchTag')->name('tag-5.7.3');
        Route::get('burovoj-rastvor-tsirkulyatsiya/ochistka/pesko-otdeliteli',     'SearchController@searchTag')->name('tag-5.7.4');
    ...
    Route::get('burovoj-rastvor-tsirkulyatsiya/pererabotka',     'SearchController@searchTag')->name('tag-5.10');
    Route::get('burovoj-rastvor-tsirkulyatsiya/stoyak',     'SearchController@searchTag')->name('tag-5.11');
...
Route::get('vrashchenie',     'SearchController@searchTag')->name('tag-21');
    ...
    Route::get('vrashchenie/verhnie-privody',     'SearchController@searchTag')->name('tag-21.3');
        ...
        Route::get('vrashchenie/verhnie-privody/komponenty',     'SearchController@searchTag')->name('tag-21.3.7');
    ...
    Route::get('vrashchenie/rotor',     'SearchController@searchTag')->name('tag-21.4');
        ...
        Route::get('vrashchenie/rotor/komponenty',     'SearchController@searchTag')->name('tag-21.4.2');
