...
return [
    ...
    'copyright' => '2020 rigmanager.com.ua. Всё права защищёны.',
    'roundicons1' => 'Все иконки предоставлены',
    'search' => 'Поиск',
    ...
    'verifyNoticeTitle' => 'Пожалуйста, Подтвердите ваш Электронный Адрес чтобы активировать аккаунт',
    'verifyNoticeResend' => 'Свежая ссылка подтверждения отправлена на ваш электронный адрес.',
    'verifyNoticeBody' => 'До того как продолжить, пожалуйста проверьте свою почту и пройдите по отправленной ссылке.
        Если вы не получили ссылку подтверждения',
    'verifyClickToResend' => 'Нажмите сюда чтобы отправить новую',
];
