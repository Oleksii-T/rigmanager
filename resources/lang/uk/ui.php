...
return [
    ...
    //mailer massages
    'mailer' => 'Mailer',
    'setUpMailer' => 'Налаштувати Mailer',
    'noMailer' => 'Ваш Mailer не налаштован',
    'whatIsMailer' => 'Що таке Mailer',
    'settingUpMailer' => 'Конфiгурацiя Mailer',
    ...
    'mailerClickToDelete' => 'Натисніть на запис щоб видалити',
    'mailerTagsHelp' => '',
    'mailerAuthors' => 'Автори',
    'deleteMailer' => 'Видалити Mailer',
    'mailerIsActive' => 'Mailer активний',
    'mailerNotActive' => 'Mailer не активний',
    'mailerAuthorsHelp' => 'Ви можете підписатися на Автора на сторінці будь-якого оголошення, біля кнопки \'Показати контакти\'.',
    'mailerAddAuthor' => 'Додати Автора в Mailer',
    'mailerRemoveAuthor' => 'Выдалити Автора з Mailer',
    'mailerNoAuthors' => 'Ви не підписалися на жодного автора',
    'mailerSuggestText' => 'Додати цей запит в Mailer?',
