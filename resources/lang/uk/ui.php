...
return [
    ...
    'mobileDev' => 'Мобільна версія знаходиться в розробці.',
   ...
   // post edit/create massages
    ...
    'postUrgentStatusHelp' => 'Термінові оголошення будуть відзначені відповідною відміткою.
        На головній сторінці показані 4 випадкових Термінових оголошень.
   ...
   'fromUserSubmit' => 'Відправити повідомлення',
    ...
    'plansCreate1Help' => 'Максимум 200 оголошень.
        Максимальний час публікації огошення: 2 місяця.',
    'plansMailer' => 'Розсилка',
    'plansTranslate' => 'Авто-Перекладач',
    'plansCreate2' => 'Створювати оголошення',
    'plansCreate2Help' => 'Максимум 500 оголошень.
        Максимальний час публікації огошення: не обмежено.',
    ...
    'planDetails' => 'Ви можете поміняти або дізнатися деталі
        про підписку тут:',
