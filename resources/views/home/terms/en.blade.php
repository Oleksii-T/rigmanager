...
@section('content')
    <article class="article" id="termsWraper">
        ...
        <div class="p">
            ...
            <p class="pb"><span class="pn">1.1</span> RIGMENGER Ltd. (hereinafter referred to as the <span class="key">Contractor</span> and/or the <span class="key">Company</span>) publishes this Public Agreement (<span class="key">Agreement</span> and/or <span class="key">Offer</span>) on the Provider's website <a class="link" href="#">LINK</a>.</p>
            ...
            <ul class="pbl">
                ...
                <li><span class="key">Website/Sites</span> - Internet site <a class="link" href="#">LINK</a>, administered by the <span class="key">Company</span>, which is a communication platform for placing temporary classified notices (hereinafter referred to as the <span class="key">Website</span> and/or <span class="key">Sites</span>);</li>
        ...
        <div>
            ...
            <p class="pb"><span class="pn">3.1</span> When placing posts, Site users grant the Company the right to process their personal data on the terms and conditions provided in Appendix 1 (CONFIDENTIAL POLICY) to this Agreement.</p>
        </div>
        <div>
        ...
        <div>
            ...
            <ul class="pbl">
                ...
                <li>The information contained in the post is in conflict with this Agreement, the rules of publishing posts of <a class="link" href="#">LINK</a> and/or legislation;</li>
        ...
        <div>
            ...
            <p class="pb"><span class="pn">6.14</span> The User has the right to send complaints about the operation of the Website through the <a class="link" href="#">LINK</a> function, which will be considered within two working days from the moment of their receipt or from the moment of receiving complete information about the essence of the complaint. The Company has the right, at its own discretion, to terminate consideration of the complaint and/or limit the number of responses to Users who violate the terms of the Agreement. The Operator providing support to the Users by phone and/or answering the phone call of the User has the right to stop the call in case of threats of the User to the Operator, the Company, obscene language, translation of the conversation on personal topics, non-objectivity of the conversation.</p>
        ...
        <div>
            ...
            <p class="pb"><span class="pn">7.3</span> Payment for the Company's paid services is made according to the procedure indicated at the following address <a class="link" href="#">LINK</a>.</p>
            ...
            <p class="pb">If the account for placing posts for prohibited goods, services or offers is blocked and the list of which is given to the address: <a class="link" href="#">LINK</a>, the funds are not returned.</p>
        ...
        <div>
            ...
            <p class="pb"><span class="pn">10.1</span> In order to improve the quality of services provided on the Websites, to comply with the requirements of legislation and to respond to changes in market conditions, this Agreement may be unilaterally amended by the Company. The new version of the Agreement comes into force from the moment of its publishing on the Internet at the address specified in this paragraph of the Agreement, unless otherwise provided by the new version of the Agreement. The current version of the Agreement is always on the page at the address <a class="link" href="#">LINK</a>.</p>
        </div>
        <div>
