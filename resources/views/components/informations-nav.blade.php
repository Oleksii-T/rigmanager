<aside class="side">
    ...
    <div class="side-block" id="side-block">
        ...
        <ul class="side-list">
            <li><a href="{{loc_url(route('about.us'))}}" class="not-ready {{$active=="about" ? 'active' : ''}}">{{__('ui.footerAbout')}}</a></li>
            <li><a href="{{loc_url(route('blog'))}}" class="not-ready {{$active=="blog" ? 'active' : ''}}">{{__('ui.footerBlog')}}</a></li>
