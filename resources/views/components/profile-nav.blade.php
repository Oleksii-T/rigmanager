...
<a class="profile-nav-link not-allowed" id="mailerBtn" href="{{loc_url(route('profile'))}}">{{__('ui.mailer')}}</a>
...
<a class="profile-nav-link not-allowed" id="TrackingBtn" href="{{loc_url(route('profile'))}}">{{__('ui.plansPostTracking')}}</a>
