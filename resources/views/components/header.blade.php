        ...
        <div class="header-block">
            ...
            <div class="header-right">
                ...
                <div class="header-cabinet">
                    <a href="{{loc_url(route('profile'))}}">{{auth()->check() ? __('ui.cabinet') : __('ui.signIn')}}</a>
                    @if (auth()->check())
                        <ul>
                            ...
                            <li><a href="{{loc_url(route('profile.posts'))}}">
                            ...
                            <li><a href="{{loc_url(route('profile.favourites'))}}">
                            ...
                            <li><a href="{{loc_url(route('mailer.index'))}}">
                            ...
                            <li><a href="{{loc_url(route('profile.subscription'))}}">
                            ...
                            <li><a href="#"  onclick="document.getElementById('logout-header-form').submit();">
                                ...
                                {{__('ui.signOut')}}
                            </a><form id="logout-header-form" action="{{ loc_url(route('logout')) }}" method="POST" hidden>@csrf</form></li>
                        </ul>
                    @endif
                </div>
            ...
            <div class="mob-nav">
                <div class="holder">
                    ...
                    <ul class="mob-nav-list">
                        ...
                        <li class="hidden"><a class="not-ready" href="{{loc_url(route('search', ['type'=>'tenders']))}}">{{__('ui.introTender')}}</a></li>
                    </ul>
                    <ul class="mob-nav-list">
