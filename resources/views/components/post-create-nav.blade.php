<aside class="side">
    ...
    <div class="side-block" id="side-block">
        ...
        <ul class="side-list">
            ...
            <li><a href="{{loc_url(route('service.create'))}}" class="not-ready {{$active=="se" ? 'active' : ''}}">{{__('ui.service')}}</a></li>
            <li><a href="#" class="not-ready {{$active=="tender" ? 'active' : ''}}">{{__('ui.tender')}}</a></li>
