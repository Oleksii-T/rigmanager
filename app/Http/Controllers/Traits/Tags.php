...
trait Tags
{
    ...
    public function constructTagsMap() 
    {
        $this->tagsMap = [
            ...
            '4' => __('tags.pump'),
                '4.1' => __('tags.pumpiI'),
                    '4.1.1' => __('tags.hydComonents'),
                    '4.1.2' => __('tags.hydActuator'),
                    '4.1.3' => __('tags.hydPulser'),
                    '4.1.4' => __('tags.hydController'),
                '4.2' => __('tags.mudPumps'),
                    '4.2.1' => __('tags.engine'),
                    '4.2.2' => __('tags.floatCollar'),
                    '4.2.3' => __('tags.pumpController'),
                    '4.2.4' => __('tags.pumpSupercharger'),
                    '4.2.5' => __('tags.pneumaticCompensator'),
                    '4.2.6' => __('tags.suctionFiler'),
                    '4.2.7' => __('tags.pressureFiler'),
                    '4.2.8' => __('tags.safeValve'),
                    '4.2.9' => __('tags.cooling'),
                    '4.2.10' => __('tags.component'),
                '4.3' => __('tags.pumpPD'),
                '4.4' => __('tags.pumpCent'),
                '4.5' => __('tags.pumpPlunger'),
                '4.6' => __('tags.pumpSinking'),
                '4.7' => __('tags.component'),
                    '4.7.1' => __('tags.compensator'),
                    '4.7.2' => __('tags.floatCollar'),
                    '4.7.3' => __('tags.filters'),
                    '4.7.4' => __('tags.barrel'),
            '5' => __('tags.mud'),
                '5.1' => __('tags.filter'),
                '5.2' => __('tags.hose'),
            ...
            '21' => __('tags.rotory'),
                ...
                '21.4' => __('tags.rotor'),
                '21.5' => __('tags.kellyBush'),
                '21.6' => __('tags.component'),
                '21.7' => __('tags.rotorDrive'),
                '21.8' => __('tags.brakes'),
            '22' => __('tags.power'),
