...
content: '<img src="/icons/showIcon.svg" alt="">',
//content: '<img src="{{ asset("icons/showIcon.svg") }}" alt="">',
attr:{"aria-pressed":"true", title:"Скрыть пароль"}
}},hidden:{className:"hideShowPassword-hidden",changeEvent:"passwordHidden",props:{type:"password"},toggle:{className:"hideShowPassword-toggle-show",
content: '<img src="/icons/hideIcon.svg" alt="">', 
//content: '<img src="{{ asset("icons/hideIcon.svg") }}" alt="">', 
attr:{"aria-pressed":"false", title:"Показать пароль"}
