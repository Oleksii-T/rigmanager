...
/*
        ...
        DB::table('posts')->insert([
            ...
            'url_name' => 'burovaya-shtanga-89x6-5x1000-mm-rezba-3-73',
...
Shipping dimensions, mm: 1800x710x970',
        ...
        DB::table('posts')->insert([
            ...
            'origin_lang' => 'ru',
            'user_translations' => '{"title":[],"description":[]}',
            'url_name' => 'trekhsharoshechnoe-doloto-76-mm-3-c-ta',
...
Rotary slips BT W (SDXL) 5 ".',
        ...
        DB::table('posts')->insert([
            ...
            'origin_lang' => 'uk',
            'user_translations' => '{"title":[],"description":[]}',
            'url_name' => 'lebіdka-ta-zapchastini',
...
'user_email' => 'pavlo.tarbeiev@gmail.com',
        ...
        DB::table('posts')->insert([
            ...
            'origin_lang' => 'ru',
            'user_translations' => '{"title":[],"description":[]}',
            'url_name' => 'kalibrator-lopastnoj-spiralnyj-180-mm',
...
API thread (GOST): З-50',
        ...
        DB::table('posts')->insert([
            ...
            'origin_lang' => 'ru',
            'user_translations' => '{"title":[],"description":[]}',
            'url_name' => 'skvazhinnaya-kamera-tel1-cabel-300-m',
...
Weight, kg: 20',
        ...
        DB::table('posts')->insert([
            ...
            'origin_lang' => 'ru',
            'user_translations' => '{"title":[],"description":[]}',
            'url_name' => 'kalibrator-lopastnoj-spiralnyj-244-mm',
...
Bottom thread API (GOST): 4 1/2 "Reg box (Z-117 coupling)',
        ...
        DB::table('posts')->insert([
            ...
            'origin_lang' => 'ru',
            'user_translations' => '{"title":[],"description":[]}',
            'url_name' => 'verkhnij-privod-fhd-6-23-r',
...
Weight, kg: 900',
        ...
        DB::table('posts')->insert([
            ...
            'origin_lang' => 'ru',
            'user_translations' => '{"title":[],"description":[]}',
            'url_name' => 'plunzhernyj-nasos-wheatley-t365-am',
...
Shipping dimensions, mm: 1200x800x500',
        ...
        DB::table('posts')->insert([
            ...
            'origin_lang' => 'ru',
            'user_translations' => '{"title":[],"description":[]}',
            'url_name' => 'utyazhelennaya-burovaya-truba-168x45x3000-mm',
            'title' => 'Утяжеленная буровая труба 168х45х3000 мм',
            'title_uk' => 'Обважена бурильна труба 168х45х3000 мм',
            'title_en' => 'Drilling Collar DC 168х45х3000 mm',
            'type' => '1',
            'role' => '1',
            'condition' => 1,
            'tag_encoded' => '2.9',
...
Weight, kg: 430',
        ...
        DB::table('posts')->insert([
            ...
            'origin_lang' => 'ru',
            'user_translations' => '{"title":[],"description":[]}',
            'url_name' => 'burovaya-truba-42x3-5x2000-mm-thread-3-43',
...
API thread (GOST): З-42',
        ...
        DB::table('posts')->insert([
            ...
            'origin_lang' => 'ru',
            'user_translations' => '{"title":[],"description":[]}',
            'url_name' => 'burovaya-truba-73х5-5х2000-mm-thread-З-635',
...
Weight, kg: 21',
        ...
        DB::table('posts')->insert([
            ...
            'origin_lang' => 'ru',
            'user_translations' => '{"title":[],"description":[]}',
            'url_name' => 'gidravlicheskij-klyuch-model-41m',
...
Shipping dimensions, mm: 600x600x600',
        ...
        DB::table('posts')->insert([
            ...
            'origin_lang' => 'ru',
            'user_translations' => '{"title":[],"description":[]}',
            'url_name' => 'obsadnaya-truba-114х10х1000-mm',
